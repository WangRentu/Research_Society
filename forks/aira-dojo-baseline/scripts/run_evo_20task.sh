#!/bin/bash
# ================================================================
# Run 006: EVO × 20 tasks × 2 seeds
# Baseline AIRA-dojo Evolutionary scaffold + Qwen 3.5-397B
...
echo "=========================================="
echo "  $RUN_ID: EVO × ${#TASKS[@]} tasks × $NUM_SEEDS seeds"
...
for task in "${TASKS[@]}"; do
    for seed in $(seq $SEED_START $SEED_END); do
        ...
        CUDA_VISIBLE_DEVICES=$gpu PYTORCH_JIT=0 nohup python -m dojo.main_run \
            +_exp=airsbench/aira_evo_qwen_single \
