#!/bin/bash
# ================================================================
# MC-ESES × 20 tasks × 2 seeds
# Cogito MC-ESES solver + Qwen 3.5-397B
...
echo "=========================================="
echo "  $RUN_ID: MC-ESES × ${#TASKS[@]} tasks × $NUM_SEEDS seeds"
...
for task in "${TASKS[@]}"; do
    for seed in $(seq $SEED_START $SEED_END); do
        ...
        CUDA_VISIBLE_DEVICES=$gpu PYTORCH_JIT=0 nohup python -m dojo.main_run \
            +_exp=airsbench/aira_mceses_qwen_single \
