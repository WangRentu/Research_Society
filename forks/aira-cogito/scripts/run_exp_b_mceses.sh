#!/bin/bash
# ================================================================
# Exp B: MC-ESES NAT v2
# Usage:
#   bash scripts/run_exp_b_mceses.sh 1    # run seed 1
#   bash scripts/run_exp_b_mceses.sh 2    # run seed 2
#   bash scripts/run_exp_b_mceses.sh 3    # run seed 3
# ================================================================
...
LOG_DIR="$BASE_DIR/log/exp_b_mceses_seed${SEED}_${TIMESTAMP}"
mkdir -p "$LOG_DIR"

CONDITION="mceses_nat_v1"

echo "=========================================="
echo "  Exp B: MC-ESES NAT v2 — seed $SEED"
