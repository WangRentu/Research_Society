...
This UI allows users to visulalize the results of runs in aira-cogito.
...
- Select a Base Directory Path (by default it's the logging directory `$LOGGING_DIR/aira-cogito` from your `.env` file) and click "Scan Base Directory".
