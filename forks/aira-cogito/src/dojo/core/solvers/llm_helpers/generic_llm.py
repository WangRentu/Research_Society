...
from dojo.utils.environment import get_compute_overview
...
class GenericLLM:
    ...
    def __call__(
        ...
        # Ensure newly added prompt variables are always present.
        # Jinja rendering uses StrictUndefined, so missing keys would crash the run.
        query_data.setdefault("compute_overview", get_compute_overview())
