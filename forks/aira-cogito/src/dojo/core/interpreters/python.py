...
class PythonInterpreter(Interpreter):
    ...
    def _run_session(
        ...
        # Match `python solution.py` semantics so `if __name__ == "__main__":` blocks run.
        global_scope: dict[str, Any] = {"__name__": "__main__", "__package__": None}
        while True:
            ...
            if execute_code:
                ...
                try:
                    # Keep __file__ aligned with the currently executed script.
                    global_scope["__file__"] = agent_file_name
