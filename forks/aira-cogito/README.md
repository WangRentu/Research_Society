# `aira-cogito`: AI Research Agent DOJO
<p align="center">
...
`aira-cogito` is a scalable and customizable framework for AI research agents, designed to accelerate hill-climbing on research capabilities toward a fully automated AI research scientist.
...
The following documentation is available to help you get started with `aira-cogito`:
...
- [Running Experiments](./docs/RUNNING_EXPERIMENTS.md) - How to run experiments with `aira-cogito`
...
conda activate aira-cogito
```

### **3. Install aira-cogito via pip**
```bash
pip install -e .
```
